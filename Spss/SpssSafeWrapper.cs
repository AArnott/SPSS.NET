...
namespace Spss
{
	...
	public class SpssSafeWrapper : SpssThinWrapper
	{
		...
		/// Files opened with spssOpenRead should be closed with <see cref="SpssThinWrapper.spssCloseRead"/>.
		/// </remarks>
		public static ReturnCode spssOpenRead(string fileName, out int handle)
		{
			return spssOpenRead(ref fileName, out handle);
		}
		/// <summary>
		...
		/// Files opened with spssOpenWrite should be closed with <see cref="SpssThinWrapper.spssCloseWrite"/>.
		/// </remarks>
		public static ReturnCode spssOpenWrite(string fileName, out int handle)
		{
			return spssOpenWrite(ref fileName, out handle);
		}
		/// <summary>
		...
		public static ReturnCode spssGetCaseWeightVar(int handle, out string varName)
		{
			...
			ReturnCode result = spssGetCaseWeightVar(handle, ref varName);
		...
		public static ReturnCode spssGetDEWFirst(int handle, out string data, int maxData)
		{
			...
			int len;
			ReturnCode result = spssGetDEWFirst(handle, ref data, data.Length, out len);
		...
		public static ReturnCode spssGetDEWGUID(int handle, out string asciiGUID)
		{
			...
			ReturnCode result = spssGetDEWGUID(handle, ref asciiGUID);
		...
		/// retrieved by calling spssGetDEWNext as many times as necessary. As with
		/// <see cref="SpssThinWrapper.spssGetDEWInfo"/>, <see cref="spssGetDEWFirst"/> will return SPSS_NO_DEW if the file was written
		/// with a byte order that is the reverse of that of the host.
		/// </remarks>
		public static ReturnCode spssGetDEWNext(int handle, out string data, int maxData)
		{
			data = new string(' ', maxData);
			int len;
			ReturnCode result = spssGetDEWNext(handle, ref data, data.Length, out len);
			data = (result == ReturnCode.SPSS_OK) ? data.Substring(0, len) : null;
			return result;
		}
		/// <summary>
		...
		public static ReturnCode spssGetIdString(int handle, out string id)
		{
			...
			ReturnCode result = spssGetIdString(handle, ref id);
		...
		{
			relInfo = new int[8];
			ReturnCode result = spssGetReleaseInfo(handle, relInfo);
			return result;
		}
		/// <summary>
		...
		public static ReturnCode spssGetSystemString(int handle, out string sysName)
		{
			...
			ReturnCode result = spssGetSystemString(handle, ref sysName);
		...
		public static ReturnCode spssGetTextInfo(int handle, out string textInfo)
		{
			...
			ReturnCode result = spssGetTextInfo(handle, ref textInfo);
		...
		public static ReturnCode spssGetTimeStamp(int handle, out string fileDate, out string fileTime)
		{
			...
			ReturnCode result = spssGetTimeStamp(handle, ref fileDate, ref fileTime);
		...
		/// read by the most recent call to <see cref="SpssThinWrapper.spssReadCaseRecord"/>. 
		/// </remarks>
		...
		{
			return spssGetVarAlignment(handle, ref varName, out alignment);
		}
		/// <summary>
		...
		public static ReturnCode spssGetVarCMissingValues(int handle, string varName, out MissingValueFormatCode missingFormat, out string missingVal1, out string missingVal2, out string missingVal3)
		{
			...
			ReturnCode result = spssGetVarCMissingValues(handle, ref varName, out missingFormat,
		...
		{
			return spssGetVarColumnWidth(handle, ref varName, out columnWidth);
		}
		/// <summary>
		...
		public static ReturnCode spssGetVarInfo(int handle, int iVar, out string varName, out int varType)
		{
			...
			ReturnCode result = spssGetVarInfo(handle, iVar, ref varName, out varType);
			varName = (result == ReturnCode.SPSS_OK) ? varName.Substring(0, varName.IndexOf('\0')) : null;
			return result;
		}
		/// <summary>
		...
		/// with an output file, the dictionary must be written with <see cref="SpssThinWrapper.spssCommitHeader"/> 
		...
		{
			return spssGetVarHandle(handle, ref varName, out varHandle);
		}
		/// <summary>
		...
		public static ReturnCode spssGetVarLabel(int handle, string varName, out string varLabel)
		{
			...
			ReturnCode result = spssGetVarLabelLong( handle, ref varName, ref varLabel, varLabel.Length, out len);
		...
		{
			return spssGetVarNMissingValues(handle, ref varName, out missingFormat, out missingVal1, out missingVal2, out missingVal3);
		}
		/// <summary>
		...
		public static ReturnCode spssGetVarCValueLabel(int handle, string varName, string value, out string label)
		{
			...
			ReturnCode result = spssGetVarCValueLabelLong(handle, ref varName, ref value, ref label, label.Length, out len);
		...
		{
			return spssGetVarPrintFormat(handle, ref varName, out printType, out printDec, out printWidth);
		}
		/// <summary>
		...
		{
			return spssGetVarWriteFormat(handle, ref varName, out writeType, out writeDec, out writeWidth);
		}
		/// <summary>
		...
		{
			return spssOpenAppend(ref fileName, out handle);
		}
		/// <summary>
		...
		{
			return spssOpenWriteCopy(ref fileName, ref dictFileName, out handle);
		}
		/// <summary>
		...
		{
			return spssSetCaseWeightVar(handle, ref varName);
		}
		/// <summary>
		...
		{
			return spssSetDateVariables(handle, dateInfo.Length, (int*) Marshal.UnsafeAddrOfPinnedArrayElement(dateInfo,0));
		}
		/// <summary>
		...
		{
			return spssSetDEWFirst(handle, ref data, data.Length);
		}
		/// <summary>
		...
		{
			return spssSetDEWGUID(handle, ref asciiGUID);
		}
		/// <summary>
		...
		{
			return spssSetDEWNext(handle, ref data, data.Length);
		}
		/// <summary>
		...
		{
			return spssSetIdString(handle, ref id);
		}
		/// <summary>
		...
		{
			return spssSetMultRespDefs(handle, ref mrespDefs);
		}
		/// <summary>
		...
		{
			return spssSetTextInfo(handle, ref textInfo);
		}
		/// <summary>
		...
		/// not written out to the data file until <see cref="SpssThinWrapper.spssCommitCaseRecord"/> is called.
		/// </remarks>
		public static ReturnCode spssSetValueChar(int handle, double varHandle, string value)
		{
			return spssSetValueChar(handle, varHandle, ref value);
		}
		/// <summary>
		...
		{
			return spssSetVarAlignment(handle, ref varName, alignment);
		}
		/// <summary>
		...
		{
			return spssSetVarCMissingValues(handle, ref varName, missingFormat, 
				ref missingVal1, ref missingVal2, ref missingVal3);
		}
		/// <summary>
		...
		{
			return spssSetVarColumnWidth(handle, ref varName, columnWidth);
		}
		/// <summary>
		...
		{
			return spssSetVarLabel(handle, ref varName, ref varLabel);
		}
		...
		///		<description>Dictionary has already been written with <see cref="SpssThinWrapper.spssCommitHeader"/></description>
		///	</item>
		/// <item>
		...
		{
			return spssSetVarName(handle, ref varName, varType);
		}
		...
		{
			return spssSetVarCValueLabel(handle, ref varName, ref value, ref label);
		}
		/// <summary>
		...
		{
			return spssSetVariableSets(handle, ref varSets);
		}
		/// <summary>
		...
		{
			return spssSetVarNMissingValues(handle, ref varName, missingFormat, 
		...
		{
			return spssSetVarNValueLabel(handle, ref varName, value, ref label);
		}
		...
		{
			return spssSetVarPrintFormat(handle, ref varName, printType, printDec, printWidth);
		}
		...
		{
			return spssSetVarWriteFormat(handle, ref varName, writeType, writeDec, writeWidth);
		}
		/// <summary>
		...
		/// required size of the buffer may be obtained by calling <see cref="SpssThinWrapper.spssGetCaseSize"/>. This is a fairly
		/// low-level function whose use should not be mixed with calls to <see cref="SpssThinWrapper.spssReadCaseRecord"/>
		...
		public static ReturnCode spssWholeCaseIn(int handle, out string caseRec)
		{
			...
			int caseSize;
			ReturnCode result = spssGetCaseSize(handle, out caseSize);
			if( result != ReturnCode.SPSS_OK ) 
			{
				caseRec = null;
				return result;
			...
			return spssWholeCaseIn(handle, ref caseRec);
		}
		/// <summary>
		...
		/// to <see cref="SpssThinWrapper.spssCommitCaseRecord"/> using the same file handle 
		...
		{
			return spssWholeCaseOut(handle, ref caseRec);
		}
		...
		{
			char* cVarSets;
			ReturnCode result = spssGetVariableSets(handle, out cVarSets);
			try 
			{
				if( result == ReturnCode.SPSS_OK )
		...
		/// expected to free the array by calling <see cref="SpssThinWrapper.spssFreeDateVariables"/> when it is no longer needed.
		...
		unsafe public static ReturnCode spssGetDateVariables(int handle, int[] dateInfo)
		{
			int* cDateInfo;
			int numofElements;
			ReturnCode result = spssGetDateVariables(handle, out numofElements, out cDateInfo);
			try
			{
				if( result == ReturnCode.SPSS_OK )
				{
			...
			{
				if( cDateInfo != null )
					spssFreeDateVariables( cDateInfo );
			}
		}
		/// <summary>
		...
		/// by calling <see cref="SpssThinWrapper.spssFreeMultRespDefs"/>. If the file contains no multiple response definitions,
		...
		{
			char* cMrespDefs;
			ReturnCode result = spssGetMultRespDefs(handle, out cMrespDefs);
			try 
			{
				if( result == ReturnCode.SPSS_OK )
			...
			{
				if( cMrespDefs != null )
					spssFreeMultRespDefs( cMrespDefs );
			}
		}
		/// <summary>
		...
		unsafe public static ReturnCode spssGetVarNames(int handle, out string[] varNames, out int[] varTypes)
		{
			...
			char** cVarNames;
			int* cVarTypes;
			ReturnCode result = spssGetVarNames(handle, out numVars, out cVarNames, out cVarTypes);
			if( result != ReturnCode.SPSS_OK )
			{
				varNames = null;
				varTypes = null;
			...
			else // all is well
			{
				...
				spssFreeVarNames(cVarNames, cVarTypes, numVars);
			}
			return result;
		}
