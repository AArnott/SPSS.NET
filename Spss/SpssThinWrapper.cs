...
namespace Spss
{
    ...
    public class SpssThinWrapper
    {
        ...
        [CLSCompliant(false)]
        protected static spssFreeDateVariablesDelegate spssFreeDateVariables;
        ...
        [CLSCompliant(false)]
        protected static spssFreeMultRespDefsDelegate spssFreeMultRespDefs;
        ...
        [CLSCompliant(false)]
        protected static spssFreeVarCValueLabelsDelegate spssFreeVarCValueLabels;
        ...
        [CLSCompliant(false)]
        protected static spssFreeVariableSetsDelegate spssFreeVariableSets;
        ...
        [CLSCompliant(false)]
        protected static spssFreeVarNamesDelegate spssFreeVarNames;
        ...
        internal static void LoadSpssDll()
        {
            ...
            spssCloseAppend = (spssCloseAppendDelegate)GetSpssDelegate("spssCloseAppend", typeof(spssCloseAppendDelegate));
            spssCloseRead = (spssCloseReadDelegate)GetSpssDelegate("spssCloseRead", typeof(spssCloseReadDelegate));
            spssCloseWrite = (spssCloseWriteDelegate)GetSpssDelegate("spssCloseWrite", typeof(spssCloseWriteDelegate));
            spssCommitCaseRecord = (spssCommitCaseRecordDelegate)GetSpssDelegate("spssCommitCaseRecord", typeof(spssCommitCaseRecordDelegate));
            spssCommitHeader = (spssCommitHeaderDelegate)GetSpssDelegate("spssCommitHeader", typeof(spssCommitHeaderDelegate));
            spssConvertDate = (spssConvertDateDelegate)GetSpssDelegate("spssConvertDate", typeof(spssConvertDateDelegate));
            spssConvertSPSSDate = (spssConvertSPSSDateDelegate)GetSpssDelegate("spssConvertSPSSDate", typeof(spssConvertSPSSDateDelegate));
            spssConvertSPSSTime = (spssConvertSPSSTimeDelegate)GetSpssDelegate("spssConvertSPSSTime", typeof(spssConvertSPSSTimeDelegate));
            spssConvertTime = (spssConvertTimeDelegate)GetSpssDelegate("spssConvertTime", typeof(spssConvertTimeDelegate));
            spssCopyDocuments = (spssCopyDocumentsDelegate)GetSpssDelegate("spssCopyDocuments", typeof(spssCopyDocumentsDelegate));
            spssFreeDateVariables = (spssFreeDateVariablesDelegate)GetSpssDelegate("spssFreeDateVariables", typeof(spssFreeDateVariablesDelegate));
            spssFreeMultRespDefs = (spssFreeMultRespDefsDelegate)GetSpssDelegate("spssFreeMultRespDefs", typeof(spssFreeMultRespDefsDelegate));
            spssFreeVarCValueLabels = (spssFreeVarCValueLabelsDelegate)GetSpssDelegate("spssFreeVarCValueLabels", typeof(spssFreeVarCValueLabelsDelegate));
            spssFreeVariableSets = (spssFreeVariableSetsDelegate)GetSpssDelegate("spssFreeVariableSets", typeof(spssFreeVariableSetsDelegate));
            spssFreeVarNames = (spssFreeVarNamesDelegate)GetSpssDelegate("spssFreeVarNames", typeof(spssFreeVarNamesDelegate));
            ...
            spssGetCaseSize = (spssGetCaseSizeDelegate)GetSpssDelegate("spssGetCaseSize", typeof(spssGetCaseSizeDelegate));
            ...
            spssGetCompression = (spssGetCompressionDelegate)GetSpssDelegate("spssGetCompression", typeof(spssGetCompressionDelegate));
            ...
            spssGetDEWInfo = (spssGetDEWInfoDelegate)GetSpssDelegate("spssGetDEWInfo", typeof(spssGetDEWInfoDelegate));
            spssGetDEWNextImpl = (spssGetDEWNextDelegate)GetSpssDelegate("spssGetDEWNext", typeof(spssGetDEWNextDelegate));
            spssGetEstimatedNofCases = (spssGetEstimatedNofCasesDelegate)GetSpssDelegate("spssGetEstimatedNofCases", typeof(spssGetEstimatedNofCasesDelegate));
            ...
            spssGetValueNumeric = (spssGetValueNumericDelegate)GetSpssDelegate("spssGetValueNumeric", typeof(spssGetValueNumericDelegate));
            ...
            spssGetVarCValueLabelLong = (spssGetVarCValueLabelLongDelegate)GetSpssDelegate("spssGetVarCValueLabelLong", typeof(spssGetVarCValueLabelLongDelegate));
            ...
            spssGetVarLabelImpl = (spssGetVarLabelDelegate)GetSpssDelegate("spssGetVarLabel", typeof(spssGetVarLabelDelegate));
            spssGetVarLabelLong = (spssGetVarLabelLongDelegate)GetSpssDelegate("spssGetVarLabelLong", typeof(spssGetVarLabelLongDelegate));
            ...
            spssHostSysmisVal = (spssHostSysmisValDelegate)GetSpssDelegate("spssHostSysmisVal", typeof(spssHostSysmisValDelegate));
            spssLowHighVal = (spssLowHighValDelegate)GetSpssDelegate("spssLowHighVal", typeof(spssLowHighValDelegate));
            ...
            spssQueryType7 = (spssQueryType7Delegate)GetSpssDelegate("spssQueryType7", typeof(spssQueryType7Delegate));
            ...
            spssSysmisVal = (spssSysmisValDelegate)GetSpssDelegate("spssSysmisVal", typeof(spssSysmisValDelegate));
