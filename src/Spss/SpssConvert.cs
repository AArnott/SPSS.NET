...
namespace Spss
{
    ...
    public class SpssConvert
    {
        ...
        /// <summary>
        /// Gets the callback method for when the process is complete.
        /// </summary>
        protected EventHandler NotifyDoneCallback => this.notifyDoneCallback;

        #region Construction

        /// <summary>
        /// Initializes a new instance of the <see cref="SpssConvert"/> class.
        /// </summary>
